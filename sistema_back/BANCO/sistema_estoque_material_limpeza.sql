...
--
-- Table structure for table `material_limpeza`
--

DROP TABLE IF EXISTS `material_limpeza`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `material_limpeza` (
...
--
-- Dumping data for table `material_limpeza`
--

LOCK TABLES `material_limpeza` WRITE;
/*!40000 ALTER TABLE `material_limpeza` DISABLE KEYS */;
INSERT INTO `material_limpeza` VALUES (1,'','','2024-03-21','09:32:00','','','','');
/*!40000 ALTER TABLE `material_limpeza` ENABLE KEYS */;
UNLOCK TABLES;
