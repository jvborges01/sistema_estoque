...
--
-- Table structure for table `material_expediente`
--

DROP TABLE IF EXISTS `material_expediente`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `material_expediente` (
...
--
-- Dumping data for table `material_expediente`
--

LOCK TABLES `material_expediente` WRITE;
/*!40000 ALTER TABLE `material_expediente` DISABLE KEYS */;
INSERT INTO `material_expediente` VALUES (1,'','','2024-03-21','10:02:00','','','','');
/*!40000 ALTER TABLE `material_expediente` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-03-22  9:15:20
